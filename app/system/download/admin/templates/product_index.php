...
<div class="v52fmbx product_index">
	...
	<table class="display dataTable ui-table new_effects" data-table-ajaxurl="{$_M[url][own_form]}a=dojson_list&class1={$list[class1]}&class2={$list[class2]}&class3={$list[class3]}"  data-table-pageLength="20">
		<thead>
			<tr>
				<th width="20" data-table-columnclass="met-center"><input name="id" data-table-chckall="id" type="checkbox" value="" /></th>
				<th width="300">{$_M[word][title]}</th>
