...
<div class="dropup pull-left" style="margin-left:5px;">
  <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-expanded="true">
    {$_M[word][columnmove1]}{$_M[word][goods]}
  </button>
  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
    <li role="presentation dropdown">
		<a role="menuitem" data-toggle="dropdown" class="dropdown-toggle" tabindex="-1" href="#">{$_M[word][column1]}</a>
		<ul class="dropdown-menu">
			 <li><a href="#">{$_M[word][htmColumn]}</a></li>
			 <li><a href="#">{$_M[word][htmColumn]}</a></li>
		</ul>
	</li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="#">{$_M[word][column2]}</a></li>
	<li role="presentation" class="divider"></li>
  </ul>
</div>
<div class="dropup pull-left" style="margin-left:5px;">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2">
    <li role="presentation"><a role="menuitem" tabindex="-1" href="#">{$_M[word][column1]}</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="#">{$_M[word][column2]}</a></li>
	<li role="presentation" class="divider"></li>
  </ul>
</div>
