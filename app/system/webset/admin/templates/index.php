...
<div class="v52fmbx" data-gent="{$_M[form][gent]}" data-webset-record="{$record}">
	...
	<dl>
		...
		<dd class="ftype_upload">
			...
			<span class="tips">{$_M['word']['suggested_size']} 32 * 32 ({$_M['word']['setimgPixel']}){$_M['word']['icontips']}<a href="https://www.baidu.com/s?wd=ico%E5%9B%BE%E6%A0%87%E5%88%B6%E4%BD%9C" target="_blank">{$_M[word][webset_tips2_v6]}</a>
			<br />
			{$_M[word][webset_tips1_v6]}
			</span>
		</dd>
	</dl>
	<dl>
