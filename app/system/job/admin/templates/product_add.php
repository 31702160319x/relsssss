...
-->
		...
		<dl>
			<dd>
				<span class="tips">{$_M[word][skinerr3]}{$_M[word][category]}</span>
			</dd>
		</dl>
		</div>	
...
echo <<<EOT
-->
	<h3 class="v52fmbx_hr">{$_M[word][nettext3]}</h3>
...
-->		
		...
		<dl>
			...
			<dd class="ftype_input">
				...
				<span class="tips">{$_M[word][admin_seotips1_v6]}</span>
			</dd>
		</dl>
		<dl>
		...
		<dl>
			...
			<dd class="ftype_textarea">
				...
				<span class="tips">{$_M[word][admin_seotips2_v6]}</span>
			</dd>
		</dl>
		<dl>
		...
		<h3 class="v52fmbx_hr">{$_M[word][unitytxt_15]}<span class="tips">{$_M[word][webaccess]}、{$_M[word][timedrelease]}</span></h3>
		<dl>
			<dt>{$_M[word][statips42]}</dt>
			<dd class="ftype_input">
				<div class="fbox">
