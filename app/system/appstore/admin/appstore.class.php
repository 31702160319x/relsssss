...
class appstore extends admin {
	...
	public function __construct() {
		...
		nav::set_nav(2, $_M['word']['sys_template'], 'https://#/product/','_blank');
		nav::set_nav(3, $_M['word']['appstore_Worryfree_service_v6'],'https://#/web/wuyou.htm','_blank');
		nav::set_nav(4, $_M['word']['appstore_Spacedomain_name_v6'],'https://#/web/idc.htm','_blank');
		nav::set_nav(5, $_M['word']['appstore_buildweb_v6'],'https://#/eweb/','_blank');
