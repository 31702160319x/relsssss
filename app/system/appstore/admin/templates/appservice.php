...
-->
	<div class="v52fmbx tempservice">
		<h3 class="v52fmbx_hr" style="border:1px solid #ddd; border-bottom:0;">二次开发/应用开发服务商</h3>
		<div class="applistdiv">
		<table class="display dataTable ui-table" data-table-ajaxurl="{$_M['url']['app_api']}a=dotable_appservicelist_json&info_id={$result['columnid']}&stat_key={$result['value']}&lang={$_M['lang']}&user_key={$_M['config']['met_secret_key']}" data-table-pagelength="20" data-table-datatype="jsonp">
			<thead>
				<tr>
						...
						<textarea class="none">
							<div class="v52fmbx">
								...
								<dl>
									...
									<li>获得“官方认证应用开发者”称号。<br/><span class="tips">完成官方应用开发培训并顺利结业</span>
									<a href="http://ke.qq.com/cgi-bin/courseDetail?course_id=33717" target="_blank">点此报名培训</a></li>
									<li>在应用商店上线自己的应用作品。</li>
									</ul>
									</dd>
								</dl>
								<dl>
									...
									2、报名参加官方应用开发培训并获得“官方认证应用开发者”称号。<br/>
									3、通过官网审核在应用商店上线自己的应用作品。<br/>
