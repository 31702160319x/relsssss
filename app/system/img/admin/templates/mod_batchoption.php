...
<div class="dropup pull-left" style="margin-left:5px;">
  <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true">
    {$_M[word][smstips64]}{$_M[word][modify]}
  ...
  <ul class="dropdown-menu list-type-update" role="menu">
	...
	<li role="presentation" class="divider"></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:;" data-value="displayok">{$_M[word][displaytype]}</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:;" data-value="displayno">{$_M[word][displaytype2]}</a></li>
  </ul>
</div>
<div class="dropup pull-left" style="margin-left:5px;">
