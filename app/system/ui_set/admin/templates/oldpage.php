...
<div class="v52fmbx">
	...
	<dl>
		<dd style='padding-left:10px;'>
			<a href="{$_M[url][site_admin]}index.php?n=banner&c=banner_admin&a=domanage&anyid=18&lang={$_M['lang']}" target="_blank" class="ui-addlist" style="width:100%;margin:0;text-align:center;">{$_Mp[word][indexflash]}</a>
		</dd>
	</dl>
<!--
EOT;
require $this->template('own/zujian');
echo <<<EOT
-->
