...
<div class="form-group">
	<div class="input-group">
		...
		<input type="text" name="phone" required class="form-control" placeholder="{$_M['word']['memberbasicCell']}"
		data-fv-phone="true"
...
<div class="form-group">
    <div class="input-group input-group-icon">
        ...
        <div class="input-group-addon p-0">
            <button type="button" data-url="{$_M['url']['valid_phone']}" class="btn btn-success btn-squared w-full phone-code" data-retxt="{$_M['word']['resend']}">
                {$_M['word']['phonecode']}
