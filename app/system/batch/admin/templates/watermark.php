...
<div class="v52fmbx" data-gent="{$_M[form][gent]}" data-webset-record="{$record}">
	<h3 class="v52fmbx_hr">{$_M[word][batch_wm_v6]}</h3>
<div class="v52fmbx_tbbox">

		<div class="v52fmbx_dlbox">
		<dl>
			<dt>{$_M['word']['please_select']}{$_M['word']['marks']}</dt>
			<dd>
...
-->
        <dl>
                <input type="button" id="submit1" name="button" value="{$_M['word']['batch_addwm_v6']}" class="submit" />
            &nbsp;&nbsp;&nbsp;
                <input type="button" id="submit2" name="button" value="{$_M[word][batch_rmwm_v6]}" vddalue="{$_M['word']['batchtips10']}" class="submit" />
