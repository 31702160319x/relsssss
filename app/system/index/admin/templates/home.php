...
echo <<<EOT
-->
		<a href="#" target="_blank" {$met_agents_display}>{$_M[word][help1]}<i class="fa fa-angle-right"></i></a>
<!--
EOT;
}
echo <<<EOT
...
-->
	<section class="index_news">
		<h3>最新新闻<a href="https://#/" target="_blank">{$_M['word']['columnmore']}<i class="fa fa-angle-right"></i></a></h3>
		<div id="newslist" data-newslisturl="https://#/metv5news.php?fromurl={$_M[config][met_weburl]}&action=json&listnum=6">
		</div>
	</section>
<!--
EOT;
