...
<div class="v52fmbx product_index">
	<div class="v52fmbx-table-top">
		...
		<a class="btn btn-danger" href="{$_M[url][own_form]}a=doadd&class1_select={$list[class1]}&class2_select={$list[class2]}&class3_select={$list[class3]}" role="button">{$_M[word][addinfo]}</a>
		</div>
		...
		<div class="ui-float-right">
			<div class="ftype_select-linkage">
				<div class="fbox" data-selectdburl="{$_M[url][own_form]}a=docolumnjson">
					<select name="class1_select" class="prov" data-table-search="1" data-checked="{$list[class1]}" data-required='1'></select>
					<select name="class2_select" class="city" data-table-search="1" data-checked="{$list[class2]}" data-required="1"></select>
					<select name="class3_select" class="dist" data-table-search="1" data-checked="{$list[class3]}" data-required="1"></select>
				</div>
			</div>
		</div>
	</div>
	...
	<table class="display dataTable ui-table" data-table-ajaxurl="{$_M[url][own_form]}a=dojson_list&class1={$list[class1]}&class2={$list[class2]}&class3={$list[class3]}"  data-table-pageLength="20">
		<thead>
			<tr>
				...
				<a href="javascript:;" class="orderby-link">{$_M[word][updatetime]}</a>
