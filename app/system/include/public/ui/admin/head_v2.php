    ...
    <div class="container-fluid h-100p">
        ...
        <div class="metadmin-haed-right pull-xs-right h-100p vertical-align">
            <div class="vertical-align-middle">
                ...
                <?php } ?>
                <div class="btn-group" {$met_agents_metmsg}>
                    <a href="https://#/bangzhu/index.php?ver=metcms" class="btn btn-default" target="_blank">
                ...
                <div class="btn-group" {$met_agents_metmsg}>
                    ...
                    <ul class="dropdown-menu animate animate-reverse dropdown-menu-right text-xs-center">
                        ...
                        <li class="dropdown-item">
                            <a href="https://#/web/product.htm" target="_blank" class='block'>{$_M['word']['sys_authorization2']}</a>
                        </li>
                        <li class="dropdown-item">
