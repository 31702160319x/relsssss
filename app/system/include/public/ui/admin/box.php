...
# Copyright (C) MetInfo Co.,Ltd (https://#). All rights reserved.
...
echo <<<EOT
-->
					<li class="met-tool-list text-center"><a target="_blank" class="liaojie" href="https://#/web/product.htm">{$_M['word']['sys_authorization2']}</a></li>
...
-->
			...
			<ul class="dropdown-menu animate animate-reverse" role="menu" aria-labelledby="dropdownMenu1">
				...
				<a href="https://#/news/shownews1248.htm" target="_blank">{$_M['word'][systips11]}</a>
				</li>
