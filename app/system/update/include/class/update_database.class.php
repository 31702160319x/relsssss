...
class  update_database extends database{
    ...
    public function recovery_admin_lang($lang)
    {
        ...
        self::add_admin_language('metinfoapplogininfo', '可用 # 官网用户中心账号登录，无需重复注册', 1, 0, 0, 0, $lang);
...
self::add_admin_language('metinfoapplogininfo', 'You can log in to the official website user center of # without repeating registration.', 1, 0, 0, 0, $lang);
