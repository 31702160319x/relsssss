...
$metui['paths']=array(
    ...
    'basic'=>array(
        ...
        // 字体
        "{$metui['url']['static2_fonts']}web-icons/web-icons.min.css",
        "{$metui['url']['static2_fonts']}font-awesome/font-awesome.min.css",
        // UI框架插件
        "{$metui['url']['static2_vendor']}breakpoints/breakpoints.min.js",// 媒体查询
        "{$metui['url']['static2_vendor']}modernizr/modernizr.min.js",// 监测浏览器支持
        // 模板框架基础配置
        "{$metui['url']['uiv2_css']}ini.css",
        "{$metui['url']['uiv2_js']}ini.js"
    ),
    // IE9兼容
    'lteie9'=>array(
    ...
    // 滑块
    'ionrangeslider'=>array(
        "{$metui['url']['static2_vendor']}ionrangeslider/ionrangeslider.min.css.css",
        "{$metui['url']['static2_vendor']}ionrangeslider/ion.rangeSlider.min.js"
    ),
    // 拖动
    ...
    // 图片懒加载
    'lazyload'=>"{$metui['url']['uiv2_plugin']}jquery.lazyload.min.js",
    // 相册1
    'lightgallery'=>array(
    ...
    // 上传文件
    'fileinput'=>"{$metui['url']['static2_vendor']}fileinput/fileinput.min.js",
    // 模板框架公共UI
