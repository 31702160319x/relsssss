...
?>
<link href="<?php echo $url['site'];?>app/system/include/static2/vendor/bootstrap/bootstrap.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo $url['site'];?>app/system/include/static2/vendor/bootstrap/bootstrap-extend.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo $url['site'];?>app/system/include/static2/assets/css/site.min.css" rel="stylesheet" type="text/css">
<link href="<?php echo $url['site'];?>public/ui/v2/static/css/basic<?php echo $basic_css_name;?>-lteie9-1.css?<?php echo $lteie9_css_filemtime;?>" rel="stylesheet" type="text/css">
<?php
    }else{
...
<?php } ?>
<style>
.login-index{background:<?php echo $c['met_member_bgcolor'];?>;<?php echo $loginbg;?>}
</style>
<div class="met-member login-index page p-y-50">
	<div class="container">
		<form method="post" action="<?php echo $_M['url']['login_check'];?>" class='met-form met-form-validation'>
			<input type="hidden" name="gourl" value="<?php echo $_M['form']['gourl'];?>" />
			<div class="form-group">
				<input type="text" name="username" class="form-control" placeholder="<?php echo $_M['word']['logintips'];?>" required
				data-fv-notempty-message="<?php echo $_M['word']['noempty'];?>"
				>
			</div>
			<div class="form-group">
				<input type="password" name="password" class="form-control" placeholder="<?php echo $_M['word']['password'];?>" required
				data-fv-notempty-message="<?php echo $_M['word']['noempty'];?>"
				>
			</div>
			<?php if($_M['code']){ ?>
			<div class="form-group">
				<div class="input-group input-group-icon">
					<input type="text" name="code" class="form-control" placeholder="<?php echo $_M['word']['memberImgCode'];?>" required data-fv-notempty-message="<?php echo $_M['word']['noempty'];?>">
			...
			<?php } ?>
			<div class="login_link text-xs-right m-b-15"><a href="<?php echo $_M['url']['getpassword'];?>"><?php echo $_M['word']['memberForget'];?></a></div>
			<button type="submit" class="btn btn-lg btn-primary btn-squared btn-block"><?php echo $_M['word']['memberGo'];?></button>
			...
			<div class="login_type text-xs-center m-t-20">
				<p><?php echo $_M['word']['otherlogin'];?></p>
				<ul class="blocks-3 m-0">
					<?php if($_M['config']['met_qq_open']){ ?>
                    <li class='m-b-0'><a title="QQ<?php echo $_M['word']['login'];?>" href="<?php echo $_M['url']['login_other'];?>&type=qq"><i class="fa fa-qq font-size-30"></i></a></li>
					<?php
				    }
				    if($_M['config']['met_weixin_open'] && !(!is_weixin_client() && is_mobile_client())){
					?>
                    <li class='m-b-0'><a href="<?php echo $_M['url']['login_other'];?>&type=weixin"><i class="fa fa-weixin light-green-600 font-size-30"></i></a></li>
					<?php
				    }
				    if($_M['config']['met_weibo_open']){
					?>
                    <li class='m-b-0'><a href="<?php echo $_M['url']['login_other'];?>&type=weibo"><i class="fa fa-weibo red-600 font-size-30"></i></a></li>
					<?php } ?>
				</ul>
			</div>
			<?php } ?>
			<?php if($_M['config']['met_member_register']){ ?>
			<a class="btn btn-lg btn-info btn-squared btn-block m-t-20" href="<?php echo $_M['url']['register'];?>"><?php echo $_M['word']['logintips1'];?></a>
			<?php } ?>
		</form>
	</div>
</div>
