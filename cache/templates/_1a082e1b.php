...
<div class="register-index met-member page p-y-50 bg-pagebg1">
	<div class="container ">
	<form class="form-register ui-from met-form-validation panel panel-body" method="post" action="<?php echo $_M['url']['password_email'];?>">
		<h1 class='m-t-0 m-b-20 font-size-24 text-xs-center'><?php echo $_M['word']['getTip5'];?></h1>
		<div class="form-group">
			<input type="text" name="username" class="form-control" placeholder="<?php echo $_M['word']['getpasswordtips'];?>" required data-fv-notempty-message="<?php echo $_M['word']['noempty'];?>">
		</div>
		<?php if($_M['config']['met_memberlogin_code']){ ?>
		<div class="form-group">
		    <div class="input-group input-group-icon">
		        <span class="input-group-addon"><i class="fa fa-shield"></i></span>
		        <input type="text" name="code" required class="form-control" placeholder="<?php echo $_M['word']['memberImgCode'];?>" data-fv-notempty-message="<?php echo $_M['word']['js14'];?>">
		...
		<?php } ?>
		<button class="btn btn-lg btn-primary btn-squared btn-block" type="submit"><?php echo $_M['word']['next'];?></button>
		<div class="login_link m-t-10 text-xs-right"><a href="<?php echo $_M['url']['login'];?>"><?php echo $_M['word']['relogin'];?></a></div>
	</form>
	</div>
</div>
<?php
